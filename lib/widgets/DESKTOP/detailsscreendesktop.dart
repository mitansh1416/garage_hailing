// ignore_for_file: prefer_typing_uninitialized_variables, use_build_context_synchronously, no_logic_in_create_state, non_constant_identifier_names
...
import '../../services/bookingrequest.dart';
import '../../services/googlemapsdirection.dart';

// ignore: must_be_immutable
class Detailsscreendesktop extends StatefulWidget {
  var datag;
  Detailsscreendesktop({Key? key, required this.datag}) : super(key: key);

  @override
  State<Detailsscreendesktop> createState() =>
      _DetailsscreendesktopState(datag);
}
...
class _DetailsscreendesktopState extends State<Detailsscreendesktop> {
  ...
  _DetailsscreendesktopState(this.datag);
                                                                    ...
                                                                    child: Row(
                                                                      children: [
                                                                        ...
                                                                        TextButton(
                                                                            ...
                                                                            child:
                                                                                Text(datag[index].phone_number.toString())),
                                                                        const Text(
                                                                            ' To confirm on services required & booking schedule',
                                                                            style:
