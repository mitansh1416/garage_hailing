...
class Detailsscreentab extends StatefulWidget {
  var datag;
  Detailsscreentab({Key? key, required this.datag}) : super(key: key);

  @override
  // ignore: no_logic_in_create_state
  State<Detailsscreentab> createState() => _DetailsscreentabState(datag);
}

class _DetailsscreentabState extends State<Detailsscreentab> {
  var datag;
  ...
  _DetailsscreentabState(this.datag);
